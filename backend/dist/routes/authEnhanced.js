...
router.post('/register', authService_1.authenticateToken, (0, authService_1.requirePermission)('canManageUsers'), registerValidation, async (req, res) => {
    try {
        if (!handleValidationErrors(req, res))
            return;
...
// GET /api/auth/me
router.get('/me', authService_1.authenticateToken, async (req, res) => {
    try {
        const user = req.user;
        res.json({
            success: true,
...
router.put('/change-password', authService_1.authenticateToken, changePasswordValidation, async (req, res) => {
    try {
        if (!handleValidationErrors(req, res))
            return;
...
router.put('/reset-password/:userId', authService_1.authenticateToken, (0, authService_1.requirePermission)('canManageUsers'), async (req, res) => {
    try {
...
router.get('/users', authService_1.authenticateToken, (0, authService_1.requirePermission)('canManageUsers'), async (req, res) => {
    try {
...
router.put('/users/:userId/status', authService_1.authenticateToken, (0, authService_1.requirePermission)('canManageUsers'), async (req, res) => {
    try {
        const { userId } = req.params;
