...
const appEnhancedSimple_1 = require("./appEnhancedSimple");
// Enhanced application startup (without WebSocket)
async function startEnhancedApplication() {
    try {
        logger_1.logger.info('🚀 Starting Bal-Con Builders Enhanced Application...');
        logger_1.logger.info('📋 Phase 5A: Advanced Feature Enhancement (Core Features)');
        logger_1.logger.info('🔧 Features: Authentication, Database Integration, Security');
        // Start the enhanced application
        await appEnhancedSimple_1.balConApp.start();
        ...
        logger_1.logger.info('');
        logger_1.logger.info('🔄 To reset database: npm run db:reset:enhanced');
        logger_1.logger.info('🌱 To seed data: npm run db:seed:enhanced');
    }
    catch (error) {
