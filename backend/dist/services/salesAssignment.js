...
exports.getSalesRepMetrics = exports.unassignSalesRep = exports.assignSalesRep = exports.autoAssignSalesRep = exports.getSalesRepWorkloads = exports.generateInquiryNumber = void 0;
...
const generateInquiryNumber = async () => {
    ...
    // Find the latest inquiry number for this year
    ...
    let nextNumber = 1;
    if (latestProject) {
        const lastNumberStr = latestProject.inquiryNumber.split('-')[2];
